...
custom_property_name="github-api-scripts-org-property"


jq -n \
           --arg name "${repo}" \
           '{
             "value_type":"single_select","required":true,"default_value":"production","description":"Prod or dev environment","allowed_values":["production","development", "github-api-scripts"]
           }' > ${json_file}
