...
#
GIT_HTTP_USER_AGENT="github-api-scripts"
export GIT_HTTP_USER_AGENT

# In the babeld log you'll now get http_ua=github-api-scripts:
# Jun 10 07:40:31 ghe.test.com babeld[3395]: ts=2023-06-10T07:40:31.573371Z pid=1 tid=113 version=80b65cb proto=http id=366d5cb0f378a4f86f5bd64717c10b34 http_url="/acme/testrepo.git/info/refs?service=git-upload-pack" http_ua="github-api-scripts" i
