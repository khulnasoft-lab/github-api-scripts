...
Thanks to @kyanny, The Power now has `base64encode.py` to free it from relying on the behaviours of operating system supplied `base64` commands.  For the backstory see [#70](https://github.com/khulnasoft-lab/github-api-scripts/issues/70) where the Homebrew base64 command on mac can break things.
