...
![github-api-scripts](https://github.com/khulnasoft-lab/github-api-scripts/actions/workflows/github-api-scripts.yml/badge.svg)


## Table of Contents

1. [What is the Power?](#what-is-github-api-scripts)
...
[hurl-repo-characteristics.sh](https://github.com/khulnasoft-lab/github-api-scripts/blob/main/hurl-repo-characteristics.sh) shows [hurl](https://hurl.dev) provisioned with values `.gh-api-examples.conf`:
